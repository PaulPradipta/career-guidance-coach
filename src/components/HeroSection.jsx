...
const HeroSection = () => {
  return (
    <div className=" h-[600px] w-full mt-[120px] px-24 py-12  gap-5 font-serif">
      ...
      <div className="animate__animated animate__slideInRight animate__slower flex flex-1  bg-white justify-center z-50 absolute top-70 h-fit right-35 flex-col space-y-3.5 w-[800px] py-12 px-8 border-b-4 border-b-gray-700 shadow-sm">
